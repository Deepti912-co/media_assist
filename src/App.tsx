...
import { analyzeMedicalData, generateVoiceResponse, generateSpeech, classifyIntent } from './services/geminiService';
import { 
  AnalysisOutput, 
  PatientProfile, 
  MedicalTestResult, 
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button 
                  ...
                  className="w-full sm:w-auto px-8 py-4 bg-brand-primary text-white rounded-2xl font-semibold shadow-lg shadow-teal-100 hover:bg-brand-dark hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2"
                >
                  Start Analysis <ArrowRight size={20} />
                </button>
                <button 
                  onClick={() => setView('voice')}
                  className="w-full sm:w-auto px-8 py-4 bg-white border border-brand-primary text-brand-primary rounded-2xl font-semibold hover:bg-teal-50 transition-all flex items-center justify-center gap-2"
                >
                  <Mic size={20} />
